...
//base url
String url = 'https://monitorride.com/'; //please add '/' at the end of url as 'yourwebsite.com/'
String mapkey = 'AIzaSyC9z5yJ9NiaDBtmwKXPND4l0rHxjB7ZPhs';
...
verifyUser(String number) async {
  ...
  try {
    ...
    if (e is SocketException) {
      print("e : $e");
      print("e : $e");print("e : $e");internet = false;
    }
  }
}
